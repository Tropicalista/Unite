...
<div class="col-md-8">
	...
	<cfif rc.year NEQ 0>
		<p class="buttonBar">
			<a href="#cb.linkHome()#" title="Remove filter and view all entries">Remove Filter</a>
		</p>
		<div class="infoBar">
			Year: '#rc.year#'
...
<!--- SideBar: That's right, I can render any layout views by using quickView() or coldbox's render methods --->
<div class="col-md-4">#cb.quickView(view='_blogsidebar')#</div>
